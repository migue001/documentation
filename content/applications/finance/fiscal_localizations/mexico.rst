...
.. list-table::
   ...
   * - :guilabel:`Mexico - Electronic Delivery Guide - Version 3.0` & :guilabel:`Mexico - Electronic Delivery Guide Comex - Version 3.0`
     - `l10n_mx_edi_stock_30` & `l10n_mx_edi_stock_extended_30`
...
an Invoice. If the customer you are selling too does not require an invoice, a *CFDI to Public* has to 
be created. 

.. /////////////////////////////////////////////////// WIP As with everything... Everything changed!!
...
(pending, first talk about GI in sales/invoicing)
...
.. reminder to myself add this http://omawww.sat.gob.mx/tramitesyservicios/Paginas/catalogos_emision_cfdi_complemento_ce.htm somewhere
...
.. FEAV - Carta porte 3.1 is not even out yet but it sure will be when we finish this...
...
.. And more things! I think so https://www.odoo.com/es_ES/forum/ayuda-1/l10n-mx-generacion-de-carta-porte-3-0-248944

In order to use this feature, the modules :guilabel:`l10n_mx_edi_stock`,
:guilabel:`l10n_mx_edi_stock_30`, :guilabel:`l10n_mx_edi_stock_extended` and
:guilabel:`l10n_mx_edi_stock_extended_30` have to be installed.
...
Odoo manages two different types of CFDI type "T":
